...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, default="./weights/yolo-fastest-xl.weights", help="path to weights file")
    ...
    dataloader = DataLoader(
        ImageFolder(opt.image_folder, transform=transforms.Compose([DEFAULT_TRANSFORMS, Resize(opt.img_size)])),
