...
if __name__=='__main__':
    import os
    import json
    dataRoot    = r'D:/dataset/ICDAR2019/'##icdr 数据所在目录
    darknetRoot = r'D:/dataset/ICDAR2019/'##darknet目录
    # wP          = r'../weights/yolo-fastest'##darknet 预训练模型权重
    ...
    JPEGP = os.path.join(darknetRoot,'VOCdevkit','VOC2007','images')
