...
from crnn.detector.detectors import TextDetector
from apphelper.image import get_boxes,letterbox_image
from crnn.opencv_dnn_detect import angle_detect##文字方向检测,支持dnn/tensorflow
...
if ocrFlag=='torch':
    from crnn.models.crnn_torch import crnnOcr as crnnOcr ##torch版本ocr
# elif ocrFlag=='keras':
# from crnn.crnn_keras import crnnOcr as crnnOcr ##keras版本OCR


if opencvFlag=='opencv':
    from crnn import opencv_dnn_detect as detect ##opencv dnn model for darknet
# elif opencvFlag=='darknet':
#     from crnn import darknet_detect as detect
# else:
#     ## keras版本文字检测
